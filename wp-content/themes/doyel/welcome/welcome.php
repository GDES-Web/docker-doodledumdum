                ...
                <div class="doyel-welcome-notice-wrap">
                    ...
                    <div class="doyel-welcome-info">
                        <div class="doyel-welcome-import">
                            <p><a class="button button-primary" target="_blank" href="<?php echo esc_url( __( 'https://ashathemes.com/preview/', 'doyel' ) ); ?>"><?php esc_html_e( 'View Demo', 'doyel' ); ?></a></p>
                        </div>
                    ...
                    <a href="<?php echo wp_nonce_url(add_query_arg('doyel_hide_notice2', 1), 'doyel_hide_notice2_nonce', 'doyel_notice_panel'); ?>" class="notice-close"><?php esc_html_e('Dismiss', 'doyel'); ?></a>
                </div>
